...
zenContactApp.controller('ContactEditController', ['$scope', 'contactService', '$routeParams', '$location', 'Contact',
  function ($scope, contactService, $routeParams, $location, Contact) {
  if ($routeParams.id) {
